...
[![Release](https://img.shields.io/github/v/release/latest-debs/git-delta-debian)](https://github.com/latest-debs/git-delta-debian/releases)
[![Build](https://github.com/latest-debs/git-delta-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./git-delta_*.deb
```

## Verify

```sh
apt-cache policy git-delta
git-delta --version
```
...
For issues with git-delta itself, see
